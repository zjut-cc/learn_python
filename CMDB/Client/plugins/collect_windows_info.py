...
class Win32Info(object):
    ...
    def get_cpu_info(self):
        '''
        获取cpu的相关数据，这里只采集了三个数据，实际有更多，自行选择需要的数据
        :return:
        '''
        data = {}
    ...
    def get_ram_info(self):
        ...
        data = []
        # 这个模块用SQL语言获取数据
        ram_collections = self.wmi_service_connector.ExecQuery("Select * form Win32_PhyscialMemory")
        for ram in ram_collections:     # 主机中存在很多内存，要循环所有的内存数据
