...
def frame_spinner_factory(*frames):
    ...
    def inner_factory(length_actual=None):
        ...
        def inner_spinner():
            for frame in frames: # TODO change to yiled from,when droppong python 2.7
                yield frame
...
def compound_spinner_factory(*spinner_factories):
    '''
    Create a factory of a spinner that combins any other spinners together.
    :param spinner_factories:
    :return:
    '''
...
def delayed_spinner_factory(spinner_factory, copies, offset):
    '''
    Creata a factory of a spinner that copies itself several times,
    with an increasing iteration offset between them.
    :param spinner_factory:
    :param copies:
    :param offset:
    :return:
    '''
